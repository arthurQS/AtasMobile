...
- [ ] Implementar senha master do bispado (join seguro)
- [ ] Regras de seguranca por unidade/bispado
- [ ] Status, auditoria e resolucao de conflitos

## Phase 4 - Quality and tests (R12)
